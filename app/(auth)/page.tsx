...
import { CheckCircle, Mail, Target } from 'lucide-react';
...
const CONTRIBUTORS = [
  'Benakesh S   |    [4JN22CSO25]',
  'Bhagath Mohan |  [4JN22CS026]',
  'Harsha H J  |  [4JN22CS047]',
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="bg-white shadow-lg rounded-md">
            {CONTRIBUTORS.map((contributor, index) => (
              <DropdownMenuItem key={index} className="text-gray-700 hover:bg-gray-100 px-4 py-2 text-sm">
                {contributor}
              </DropdownMenuItem>
            ))}
          </DropdownMenuContent>
...
function FeatureItem({ icon, title, description }:some) {
  return (
